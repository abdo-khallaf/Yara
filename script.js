...
const invitation = {
    ...
    name2: "Yara",                                  // Her name
    date: "2026-09-03",                               // Engagement date — format: YYYY-MM-DD
    ...
    // ⭑ YOUR PERSONAL PHOTO ⭑
    // Just replace the file at assets/couple-photo.jpg with your own image
    // (keep the same filename) — it will automatically appear in the hero
    // circle frame, the couple section, and the final section background.
    // A placeholder graphic ships in that spot so nothing looks broken
    // until you swap it. A 4:5 portrait crop looks best.
    photo: "assets/couple-photo.jpg",
